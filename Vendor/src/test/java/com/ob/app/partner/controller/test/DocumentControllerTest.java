...
import com.ob.app.vendor.controller.DocumentController;
...
class DocumentControllerTest {
	...
	public void getAllDocumentTest() {
		...
		document1.setDocumentId(2);
		document1.setDocumentName("tan");
		document1.setTanNo("234345");
		docList2.add(document1);
		docList1.add(document2);
